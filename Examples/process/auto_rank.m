...
% reconstruction without prioir knowledge of the true process matrix rank.
% An optimal rank is estimated using the adequcy criteria.
...
% proto_meas = rt_proto_measurement('tetra', 'modifier', 'operator'); % Uncomment to test binomial stats
...
chi_rec = rt_chi_reconstruct(ex, 'significanceLevel', 0.01, 'Display', 10);
