...
% reconstruction without prioir knowledge of the true density matrix rank.
...
% proto = rt_proto_measurement('tetra', 'modifier', 'operator'); % Uncomment to test binomial stats
